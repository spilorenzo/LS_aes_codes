...
int main(int argc, const char * argv[]) {
    ...
    masked_state aes_state_shares, aes_key_shares, aux;
    
    state a;
    
    printf("aes_state:\n");
    printstate(aes_state);
    
    printf("aes_state1:\n");
    printstate(aes_state1);
    
    encoding(aes_state, aes_state_shares);
    encoding(aes_state1, aes_key_shares);
    
    secmult_ilr2(aes_state_shares, aes_key_shares, aux);
    
    decoding(aux, a);
    
    printf("aes_state after locality refreshing:\n");
    printstate(a);
